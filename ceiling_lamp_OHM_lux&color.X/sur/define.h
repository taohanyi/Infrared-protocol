...
#define NightL   PORTCbits.RC0
#define BzCom    PORTCbits.RC1
#define CoolShut PORTCbits.RC4
#define WarmShut PORTCbits.RC5
#define DimCom   PWM2

#define OFF    0
#define ON     1
#define SwitchLevel     20

//#define BzLong     10000	//1s
#define BzShort	     1000	//0.1s
#define BzInterval   700

#define SaveDataRoom  96
